...
function renderSettings() {
  ...
  screen.querySelector('#volume').addEventListener('input', (e) => {
    ctx.save.volume = Number(e.target.value);
    persist();
    sound.ui();
  });
